 ...
 * their defined attributes. There is, however, no requirement that an instance
 * reside in a data frame. Adding a new attribute to an instance does not
 * automatically add the attribute to the data frame; instead it must be added
 * to both.
 */
