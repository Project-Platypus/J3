...
/**
 * Mimics CSS or D3/jQuery selectors to quickly locate nodes within a JavaFX
 * scene graph. Supported types are:
 * <ul>
 ...
 * </ul>
 * The basic usage is {@code Selector.on(scene).select("#id").get()}. A Java
 * class can also be provided to the {@code get} method for type-safety. When
 * matching against a unique id, it is more efficient to use {@code getFirst()}.
 */
