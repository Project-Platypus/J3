...
public class ColorbarProvider implements WidgetProvider {
	...
	public String getDescription() {
		return "Display a colorbar";
	}

	@Override
	public Image getIcon() {
		return new Image(WidgetOptions.class.getResourceAsStream("/j3/icons/legend_1x.png"));
	}
