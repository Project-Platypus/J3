	...
	public void onAdd(Canvas canvas) {
		text.setOnMouseClicked(event -> {
			if (event.getButton() == MouseButton.PRIMARY && event.getClickCount() % 2 == 0) {
				...
				bold.setGraphic(new ImageView(
						new Image(TextWidget.class.getResourceAsStream("/j3/icons/bold_1x_nopadding.png"))));
				italic = new ToggleButton();
				italic.setGraphic(new ImageView(
						new Image(TextWidget.class.getResourceAsStream("/j3/icons/italic_1x_nopadding.png"))));
				underline = new ToggleButton();
				underline.setGraphic(new ImageView(
						new Image(TextWidget.class.getResourceAsStream("/j3/icons/underline_1x_nopadding.png"))));
				...
				cancelButton.setGraphic(
						new ImageView(new Image(TextWidget.class.getResourceAsStream("/j3/icons/cancel.png"))));
