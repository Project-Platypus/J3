...
public abstract class Axis {
	...
	/**
	 * Returns the tick positions on the axis.  Positions are scaled between
	 * 0 and 1.
	 * 
	 * @return
	 */
	...
	/**
	 * Maps from a value to a number between 0 and 1.  This number will
	 * subsequently be scaled by the plotting routines to fit the plot.
	 * 
	 * @param value
	 * @return
	 */
