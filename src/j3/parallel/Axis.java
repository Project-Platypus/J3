...
//    Pane axisBody = new Pane();
//    final Path tickMarkPath = new Path();
...
//        
//        axisBody.getChildren().add(tickMarkPath);
//        axisBody.setPrefWidth(getWidth());
//        
//        getChildren().addAll(axisBody, axisLabel);
//    }
//
//    // -------------- METHODS ------------------------------------------------------------------------------------------
//
...
//                axisBody.getChildren().add(tick.textNode);
//                tickMarks.add(tick);
//                if (shouldAnimate()) {
...
//            tickMarkPath.setStrokeWidth(2.0);
//            tickMarkPath.setStroke(Color.BLACK);
//            
//            if (getLabel() != null) {
//                //axisLabel.getTransforms().setAll(new Translate(0, height), new Rotate(0, 0, 0));
//                axisLabel.setLayoutX(0);
//                axisLabel.setLayoutY(-axisLabel.prefHeight(width));
//                //noinspection SuspiciousNameCombination
//                axisLabel.resize(Math.ceil(getWidth()), Math.ceil(axisLabel.prefHeight(width)));
//            }
//            tickIndex = 0;
//            for (int i = 0; i < tickMarks.size(); i++) {
//                TickMark<T> tick = tickMarks.get(i);
//                positionTextNode(tick.textNode, width/2.0 - getTickLabelGap() - tickMarkLength,
...
//                            new MoveTo(width/2.0 - tickMarkLength/2.0, tick.getPosition()),
//                            new LineTo(width/2.0 + tickMarkLength/2.0, tick.getPosition())
//                    );
//                } else {
...
//            
//            tickMarkPath.getElements().addAll(
//            		new MoveTo(width/2.0, 0.0),
//            		new LineTo(width/2.0, height));
//            
